...
// COLOURS
// ------------------------------------------------------------------------------------
const NAVY: RGB = rgb(0.039, 0.059, 0.118);
const GOLD: RGB = rgb(0.910, 0.631, 0.125);
const BLACK: RGB = rgb(0, 0, 0);
const GREY: RGB = rgb(0.5, 0.5, 0.5);
const WHITE: RGB = rgb(1, 1, 1);
const LIGHT: RGB = rgb(0.95, 0.95, 0.95);
...
export async function generatePDFBuffer(data: PDFData): Promise<Uint8Array> {
  ...
  page.drawText(footerText, { x: 40, y: 26, size: 8, font: fontReg, color: rgb(0.75, 0.75, 0.75) });
