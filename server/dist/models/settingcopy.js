...
const Settings = database_1.default.define('CompanySettings', {
    id: {
...
module.exports = {
    async up(queryInterface, Sequelize) {
        await queryInterface.createTable('settings', {
            ...
            // Bank name shown in the payment details section of the invoice
            // e.g. "GTBank" shown in the prototype invoice PDF
            company_bank: {
                type: Sequelize.STRING(100),
                allowNull: true,
            },
            // Bank account number shown in the payment details section of the invoice
            // e.g. "0123456789" shown in the prototype invoice PDF
            company_account: {
                type: Sequelize.STRING(50),
                allowNull: true,
            },
            // Text printed at the bottom of every invoice PDF
            // Editable from the Settings page — "Invoice Footer Text" field in the prototype
            invoice_footer: {
                type: Sequelize.TEXT,
                allowNull: true,
                defaultValue: 'Thank you for your business.',
            },
            // Default VAT rate applied to all new quotes
            // Editable from the Settings page — "Default VAT Rate (%)" field in the prototype
            default_vat_rate: {
...
//# sourceMappingURL=settingcopy.js.map