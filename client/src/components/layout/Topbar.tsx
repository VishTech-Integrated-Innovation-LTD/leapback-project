import { ArrowRightIcon, BellIcon, ListIcon, PlusIcon, WarningIcon } from "@phosphor-icons/react";
...
// --------------------------------------------------------------------------
const Topbar = ({ lowStockCount = 0, lowStockItems = [], onMenuToggle }: TopbarProps) => {
  ...
  return (
    ...
    <header className="h-16 bg-[#0D1526] border-b border-white/10 flex items-center justify-between px-4 lg:px-6 fixed top-0 left-0 right-0 lg:left-64 z-30">
      ...
      <div className="flex items-center gap-2 lg:gap-3">
        ...
        {/* New Quote CTA - visible on all pages except New Quote itself(hide label on small screens) */}
